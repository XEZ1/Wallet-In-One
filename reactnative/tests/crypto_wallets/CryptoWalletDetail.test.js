  ...
  it('wallet transaction data test', async () => {
    ...
    await act(async () => {
      ...
      await waitFor(async () => {
        ...
        expect(screen.getByText('January 17, 2023, 4:44 PM')).toBeDefined()

        expect(screen.getByText('0.00064342 BTC')).toBeDefined()
        expect(screen.getByText('January 10, 2023, 7:02 AM')).toBeDefined()

        expect(screen.getByText('0.00000547 BTC')).toBeDefined()
        expect(screen.getByText('January 7, 2023, 4:39 AM')).toBeDefined()
